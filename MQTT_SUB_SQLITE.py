...
broker = '192.168.0.102'  #192.168.241.4
port = 1883
topic = "Data"
client_id = ''
username = 'Reinstated'
...
def create_table():
    c_cur = conn.cursor()
    c_cur.execute("CREATE TABLE IF NOT EXISTS CH0(Channel0 INT)")  # <<<<<<<<<< CHANGED
    c_cur.execute("CREATE TABLE IF NOT EXISTS CH4(Channel4 INT)")
    c_cur.execute("CREATE TABLE IF NOT EXISTS CH3(Channel3 INT)")  # <<<<<<<<<< CHANGED
    c_cur.execute("CREATE TABLE IF NOT EXISTS CH5(Channel5 INT)")
    c_cur.execute("CREATE TABLE IF NOT EXISTS CH6(Channel6 INT)")  # <<<<<<<<<< CHANGED
    c_cur.execute("CREATE TABLE IF NOT EXISTS CH7(Channel7 INT)")
    c_cur.close()
create_table()
